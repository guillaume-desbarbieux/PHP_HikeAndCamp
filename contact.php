...
<div class="container border border-black border-5 rounded-5 p-1 bg-primary w-75 mt-5">
    <form method="post" enctype="multipart/form-data">
        ...
        <h2 class="text-danger text-center font-weight-bold"><?= $_SESSION["error"]["contactForm"]["textContent"]["validation"] ?? "" ?></h2>
        <h2 class="text-danger text-center font-weight-bold"><?= $_SESSION["error"]["contactForm"]["fichier"]["validation"] ?? "" ?></h2>
        <h2 class="text-success text-center font-weight-bold"><?= $_SESSION["validation"]["contactForm"]["textContent"] ?? "" ?></h2>
        <h2 class="text-success text-center font-weight-bold"><?= $_SESSION["validation"]["contactForm"]["fichier"] ?? "" ?></h2>
