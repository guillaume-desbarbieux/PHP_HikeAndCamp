<main id="blocDescription" class="position-relative">
    ...
    <section class="container">
        <div class="row g-0 m-1 h-100">
            <div class="col-xl-4">
                <h4 class="text-center"><?= formatPrice(discountedPrice($item["prix"], $item["discount"])) ?>/Nuit (TTC)</h4>
                <h5 class="text-center"><?= formatPrice(priceExcludingVAT($item["prix"], $item["discount"])) ?>/Nuit (HT)</h5>
            </div>
